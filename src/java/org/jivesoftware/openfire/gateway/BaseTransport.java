...
import org.jivesoftware.openfire.gateway.permissions.PermissionManager;
...
import org.jivesoftware.openfire.gateway.session.TransportSessionManager;
...
public abstract class BaseTransport implements Component, RosterEventListener, UserEventListener, PacketInterceptor, SessionEventListener, VCardListener {
     ...
     * @see org.jivesoftware.openfire.gateway.session.TransportSessionManager
     */
    public final TransportSessionManager sessionManager = new TransportSessionManager(this);

    /**
     * Manages permission information.
     * @see org.jivesoftware.openfire.gateway.permissions.PermissionManager
     */
    public PermissionManager permissionManager = null;

    /**
     * Manages session routing.
     * @see org.jivesoftware.openfire.gateway.session.cluster.TransportSessionRouter
     */
     ...
     * @see org.jivesoftware.openfire.gateway.type.TransportType
     */
...
//                Log.debug("ROSTERSYNC: Mapping "+buddy.getName());
     ...
     * @param jid JID of user whose roster we want to clean up.
     * @throws UserNotFoundException if the user is not found.
     * @deprecated Use org.jivesoftware.openfire.gateway.roster.TransportBuddyManager#sendOfflineForAllAvailablePresences(JID)
     */
